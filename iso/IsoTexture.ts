...
namespace iso {
    ...
    export function drawTileInline(tile: Image, top: number, left: number) {
        let dx = 0;
        let y = top + rise;
        let upper = y;
        let lower = upper + 1;
    ...
    export function drawColorInline(color: number, top: number, left: number) {
        let dx = 0;
        let y = top + rise;
        let upper = y;
        let lower = upper + 1;
